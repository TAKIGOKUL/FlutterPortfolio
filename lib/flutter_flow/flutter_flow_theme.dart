...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFEE5638);
  late Color secondary = const Color(0xFFF85838);
  late Color tertiary = const Color(0xFF77A4BD);
  late Color alternate = const Color(0xFFB7BBB1);
  late Color primaryText = const Color(0xFF202020);
  late Color secondaryText = const Color(0xFFB7BBB1);
  ...
  late Color error = const Color(0xFFA94531);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF77A4BD);
  late Color alternate = const Color(0xFFB7BBB1);
  late Color primaryText = const Color(0xFFB7BBB1);
  late Color secondaryText = const Color(0xFF202020);
  late Color primaryBackground = const Color(0xFF202020);
  late Color secondaryBackground = const Color(0xFFB7BBB1);
  late Color accent1 = const Color(0xFFA94531);
  late Color accent2 = const Color(0x4D928163);
  late Color accent3 = const Color(0x4C6D604A);
